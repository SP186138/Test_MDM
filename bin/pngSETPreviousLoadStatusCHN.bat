...
echo "<!--***********Setting PreviousLoadStatusCHN as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusCHN.xml
%PAUSE_FLAG%
