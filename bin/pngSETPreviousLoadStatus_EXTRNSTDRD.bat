...
echo "<!--***********Setting PreviousLoadStatusBRA as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatus_EXTRNSTDRD.xml
%PAUSE_FLAG%
