...
echo "<!--***********Setting PreviousLoadStatusSGP as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusSGP.xml
%PAUSE_FLAG%
