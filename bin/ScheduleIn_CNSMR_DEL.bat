...
set secure_dir=%ETL_HOME%\secures
...
:start
echo test_bat
%util_dir%\ssed -e "s/$LOAD_ID/%LOADID%/;s/$Freq/%Frequency%/" %bin_path%\ScheduleIn_CNSMR_DEL.xmlt  > %bin_path%\ScheduleIn_CNSMR_DEL.xml

java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/ScheduleIn_CNSMR_DEL.xml

if errorlevel 1 exit /b 1

if exist %ETL_HOME%\bin\MDM_LOAD_CONTROL_CNSMR_DEL.err exit /b 1
