...
echo "<!--***********Setting PreviousLoadStatusMYS as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusMYS.xml
%PAUSE_FLAG%
