...
REM 	
REM   Parameters: EXTRN_STDRD_INITIAL <ScriptName> <Label> <LE> <CNTRY>
REM 
REM 
REM 
...
REM 5.7                  03/31/2016           TERADATA                        INITIAL VERSION
REM ******************************************************************************************/
...
%util_dir%\ssed "s/$Step/%Lbl%/;s/$LE/%LegalEnt%/;s/$CNTRY/%Country%/" %script_path%\%ScriptName%.sql  > %script_path%\%ScriptName%.run
call %exec_dir%\run_sql_merge %ScriptName%.run
...
echo.
echo		Usage : <ScriptName> <Label> <LE> <CNTRY>
echo.
