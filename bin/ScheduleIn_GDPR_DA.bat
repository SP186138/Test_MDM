...
%util_dir%\ssed -e "s/$LoadId/%LOADID%/;s/$Freq/%Frequency%/" %bin_path%\ScheduleIn_GDPR_DA.xmlt  > %bin_path%\ScheduleIn_GDPR_DA.xml

java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/ScheduleIn_GDPR_DA.xml

if errorlevel 1 exit /b 1

if exist %ETL_HOME%\bin\MDM_LOAD_CONTROL_GDPR_DA.err exit /b 1
