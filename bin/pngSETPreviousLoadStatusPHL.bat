...
echo "<!--***********Setting PreviousLoadStatusPHL as SUCCESS******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusPHL.xml
%PAUSE_FLAG%
