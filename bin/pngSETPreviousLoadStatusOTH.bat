...
echo "<!--***********Setting PreviousLoadStatusOTH as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusOTH.xml
%PAUSE_FLAG%
