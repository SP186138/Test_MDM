...
echo "<!--***********Setting PreviousWrapperLoadStatuS as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousWrapperLoadStatus.xml
%PAUSE_FLAG%
