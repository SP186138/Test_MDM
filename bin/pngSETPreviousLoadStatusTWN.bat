...
echo "<!--**********Setting PreviousLoadStatusTWN as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusTWN.xml
%PAUSE_FLAG%
