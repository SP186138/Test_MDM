...
echo "<!--***********Setting PreviousLoadStatusTREMOR as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusTREMOR.xml
%PAUSE_FLAG%
