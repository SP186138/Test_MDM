...
echo "<!--***********Setting PreviousLoadStatusOptOut as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatus_OptOut.xml
%PAUSE_FLAG%
