...
echo "<!--***********Setting PreviousDeleteLoadStatus as SUCCESS******************-->"

%util_dir%\ssed -e "s/$PRJCTID/%ProjectId%/;s/$Freq/%Frequency%/" %bin_path%\DQRM_Batch.xmlt  > %bin_path%\DQRM_Batch.xml

java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/DQRM_Batch.xml
