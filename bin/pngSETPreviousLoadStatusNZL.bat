...
echo "<!--***********Setting PreviousLoadStatusNZL as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusNZL.xml
%PAUSE_FLAG%
