...
java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/CallTimer.xml
REM java com.teradata.xcore.net.Poster xserver ..<REQUEST Name="startValidationTimer" ServiceName="BCM_MASTER"/>
