...
echo "<!--***********Setting PreviousLoadStatusAUS as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusAUS.xml
%PAUSE_FLAG%
