...
echo "<!--***********Setting PreviousLoadStatusJPN as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatusJPN.xml
%PAUSE_FLAG%
