...
echo "<!--***********Setting PreviousLoadStatusGdpr as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousLoadStatus_Gdpr.xml
%PAUSE_FLAG%
