...
echo "<!--***********Setting PreviousValidationLoadStatus as SUCCESS ******************-->"


java com.teradata.xcore.net.Poster xserver ../cfg/properties/xserver.xml BCM_MASTER ../bin/pngSETPreviousValidationLoadStatus.xml
%PAUSE_FLAG%
