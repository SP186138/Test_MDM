...
%util_dir%\ssed -f %PARAM_FILE% -f %TEMP_PARAM_FILE% -f %secure_dir%\logon_mdmtril.txt  %util_dir%\create_control_record.btq > %work_dir%\create_control_record.%SCRIPT_NAME%.%timestamp%
...
%util_dir%\ssed -f %PARAM_FILE% -f %secure_dir%\logon_mdmtril.txt  %script_location%\%SCRIPT_NAME% > %work_dir%\%SCRIPT_NAME%.%timestamp%
...
%util_dir%\ssed -f %PARAM_FILE% -f %TEMP_PARAM_FILE% -f %secure_dir%\logon_mdmtril.txt  %util_dir%\update_control_record.btq > %work_dir%\update_control_record.%SCRIPT_NAME%.%timestamp%
