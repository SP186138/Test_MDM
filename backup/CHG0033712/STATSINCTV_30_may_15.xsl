...
<xsl:template match="/">
  ...
  <h2>ERROR DETAILS</h2>
    <table border="1">
      <tr bgcolor="#9acd32">
        <th>INCTV_NBR</th>
        <th>INCTV_ITEM_NBR</th>
        <th>INCTV_ITEM_NAME</th>
        <th>INCTV_ITEM_QTY</th>
        <th>CATEG_CODE</th>
        <th>SEG_CODE</th>
        <th>BRAND_CODE</th>
	...
	<th>ITEM_VERS_CODE</th>
      ...
      <tr>
        ...
        <td><xsl:value-of select="INCTV_ITEM_NBR/@Value"/></td>
        <td><xsl:value-of select="INCTV_ITEM_NAME/@Value"/></td>
        <td><xsl:value-of select="INCTV_ITEM_QTY/@Value"/></td>
