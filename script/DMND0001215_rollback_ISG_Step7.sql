...
.LABEL L1
INSERT INTO MDM.ATTRIBUTE_VALUES SEL * FROM DEPLOY_WORK.ATTRIBUTE_VALUES_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L2
INSERT INTO MDM.ATTRIBUTE_TYPES SEL * FROM DEPLOY_WORK.ATTRIBUTE_TYPES_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L3
INSERT INTO MDM.ATTRIBUTE_TYPES_HIERARCHY SEL * FROM DEPLOY_WORK.ATTRIBUTE_TYPES_HIERARCHY_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L4
INSERT INTO MDM.ATTRIBUTE_VALUES_HIERARCHY SEL * FROM DEPLOY_WORK.ATTRIBUTE_VALUES_HIERARCHY_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L5
INSERT INTO MDM.ATTRIBUTE_TYPES_RELN SEL * FROM DEPLOY_WORK.ATTRIBUTE_TYPES_RELN_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L6
INSERT INTO MDM.ATTRIBUTE_VALUES_RELN SEL * FROM DEPLOY_WORK.ATTRIBUTE_VALUES_RELN_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L7
INSERT INTO MDM.RPT_ADDR_QLTY SEL * FROM DEPLOY_WORK.RPT_ADDR_QLTY_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L8
INSERT INTO MDM.RPT_CNSMR_NBR SEL * FROM DEPLOY_WORK.RPT_CNSMR_NBR_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L9
INSERT INTO MDM.RPT_DATA_NBR SEL * FROM DEPLOY_WORK.RPT_DATA_NBR_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L10
INSERT INTO MDM.RPT_LOAD_NBR SEL * FROM DEPLOY_WORK.RPT_LOAD_NBR_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L11
INSERT INTO MDM.tss_cntry_table_map SEL * FROM DEPLOY_WORK.tss_cntry_table_map_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L12
INSERT INTO MDM.ENV_NM SEL * FROM DEPLOY_WORK.ENV_NM_MDM_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L13
DROP TABLE MDM.ERR_PRSNA_STG;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L14
RENAME TABLE MDM.ERR_PRSNA_STG_BKUP_DMND0001215_rollback TO ERR_PRSNA_STG;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L15
...
DEL FROM upld_tmplt_prps WHERE NAME='EntityCNTNT_ELEMTemplate';
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L17
INSERT INTO MDM.upld_tmplt_prps SEL * FROM DEPLOY_WORK.upld_tmplt_prps_MDM_DMND0001215_rollback WHERE NAME='EntityINCTVTemplate';
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L18
INSERT INTO MDM.upld_tmplt_prps SEL * FROM DEPLOY_WORK.upld_tmplt_prps_MDM_DMND0001215_rollback WHERE NAME='EntityCNTNT_ELEMTemplate';
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L19
...
GROUP BY 1,2,3;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
   ...
   .LABEL L27
INSERT INTO MDM.DQRM_Email SEL * FROM DEPLOY_WORK.DQRM_Email_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 
   .LABEL L28
INSERT INTO MDM.DATA_SRCE_SUBS_OPT_IN_DMY SEL * FROM DEPLOY_WORK.DATA_SRCE_SUBS_OPT_IN_DMY_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L29
INSERT INTO MDM.DATA_SRCE_SUBS_OPT_IN SEL * FROM DEPLOY_WORK.DATA_SRCE_SUBS_OPT_IN_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L30
...
TRT_NBR ,
      ...
      DISPLAY_TYPE ,
      ID
FROM DEPLOY_WORK.TRT_IN_DUMMY_DMND0001215_rollback;
...
TRT_NBR ,
      ...
      DISPLAY_TYPE ,
      ID  
FROM DEPLOY_WORK.TRT_IN_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
  .LABEL L32
INSERT INTO MDM.PREDFND_TRT_VAL_IN SEL * FROM DEPLOY_WORK.PREDFND_TRT_VAL_IN_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
  .LABEL L33
INSERT INTO MDM.PREDFND_TRT_VAL_IN_DUMMY SEL * FROM DEPLOY_WORK.PREDFND_TRT_VAL_IN_DUMMY_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
...
.LABEL L42
INSERT INTO MDM.WS_CNSMR_GDPR_RQST SEL * FROM DEPLOY_WORK.WS_CNSMR_GDPR_RQST_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE; 

 .LABEL L43
INSERT INTO MDM.WS_CNSMR_DEL SEL * FROM DEPLOY_WORK.WS_CNSMR_DEL_DMND0001215_rollback;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
