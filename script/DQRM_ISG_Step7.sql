...
.LABEL L1
INSERT INTO MDM.ATTRIBUTE_VALUES SEL * FROM DEPLOY_WORK.ATTRIBUTE_VALUES_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L2
INSERT INTO MDM.ATTRIBUTE_TYPES SEL * FROM DEPLOY_WORK.ATTRIBUTE_TYPES_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L3
INSERT INTO MDM.ATTRIBUTE_TYPES_HIERARCHY SEL * FROM DEPLOY_WORK.ATTRIBUTE_TYPES_HIERARCHY_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L4
INSERT INTO MDM.ATTRIBUTE_VALUES_HIERARCHY SEL * FROM DEPLOY_WORK.ATTRIBUTE_VALUES_HIERARCHY_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L5
INSERT INTO MDM.ATTRIBUTE_TYPES_RELN SEL * FROM DEPLOY_WORK.ATTRIBUTE_TYPES_RELN_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L6
INSERT INTO MDM.ATTRIBUTE_VALUES_RELN SEL * FROM DEPLOY_WORK.ATTRIBUTE_VALUES_RELN_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L7
INSERT INTO MDM.RPT_ADDR_QLTY SEL * FROM DEPLOY_WORK.RPT_ADDR_QLTY_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L8
INSERT INTO MDM.RPT_CNSMR_NBR SEL * FROM DEPLOY_WORK.RPT_CNSMR_NBR_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L9
INSERT INTO MDM.RPT_DATA_NBR SEL * FROM DEPLOY_WORK.RPT_DATA_NBR_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L10
INSERT INTO MDM.RPT_LOAD_NBR SEL * FROM DEPLOY_WORK.RPT_LOAD_NBR_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L11
INSERT INTO MDM.tss_cntry_table_map SEL * FROM DEPLOY_WORK.tss_cntry_table_map_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L12
INSERT INTO MDM.ENV_NM SEL * FROM DEPLOY_WORK.ENV_NM_MDM_dqrm;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L13
DROP TABLE MDM.ERR_PRSNA_STG;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L14
RENAME TABLE MDM.ERR_PRSNA_STG_BKUP_dqrm TO ERR_PRSNA_STG;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L15
...
DEL FROM upld_tmplt_prps WHERE NAME='EntityCNTNT_ELEMTemplate';
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L17
INSERT INTO MDM.upld_tmplt_prps SEL * FROM DEPLOY_WORK.upld_tmplt_prps_MDM_dqrm WHERE NAME='EntityINCTVTemplate';
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L18
INSERT INTO MDM.upld_tmplt_prps SEL * FROM DEPLOY_WORK.upld_tmplt_prps_MDM_dqrm WHERE NAME='EntityCNTNT_ELEMTemplate';
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L19
