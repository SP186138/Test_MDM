...
PARTITION BY LEGAL_ENT_NBR ;
 ...
 COLLECT STATS MDM.MATCH_DATA_TEMP1
...
(SELECT MATCHD_CNSMR_PRSNA_ID,LEGAL_ENT_NBR 
FROM MDM.MATCH_DATA_TEMP1) AND LEGAL_ENT_NBR IN (15,42);
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L2
...
FROM ICRM_TBL.MATCHD_CNSMR_PRSNA) AND LEGAL_ENT_NBR IN (15,42);
...
INSERT INTO USER_WORK.MATCHD_CNSMR_PRSNA_TRT_MATCH1
(
...
INNER JOIN MDM.TSS_PRSNA_IDS_USA B
...
COLLECT STATS USER_WORK.MATCHD_CNSMR_PRSNA_TRT_MATCH1
COLUMN MATCHD_CNSMR_PRSNA_ID;
COLLECT STATS USER_WORK.MATCHD_CNSMR_PRSNA_TRT_MATCH1
COLUMN LEGAL_ENT_NBR;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
...
SYS_ERR_CODE                  ,
SYS_ERR_SVRTY  
FROM USER_WORK.MATCHD_CNSMR_PRSNA_TRT_MATCH1;
 .IF ERRORLEVEL > 0 THEN .QUIT ERRORCODE;
 .LABEL L25
